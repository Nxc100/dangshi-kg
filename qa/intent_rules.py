...
每条规则 = 关键词集（任一命中）∧ exclude（均未命中）∧ require_all（每组至少命中一个）
∧ 实体类型（链接实体类型须相交）→ 意图。
...
RULES = [
    ...
    {
        "intent": "I14",
        "keywords": ["参加", "出席", "参会", "到场", "与会", "去过", "代表"],
        "require_all": [["领导", "参与", "发动", "指挥", "功绩", "事迹", "负责过", "干了什么", "大事"]],
        "entity_types": ["Meeting"],
        "example": "参加{name}的人领导过哪些事件？",
    },
    {
        "intent": "I15",
        "keywords": ["作者", "谁写", "写出", "执笔", "写"],
        "require_all": [["担任", "职务", "任职", "什么职", "岗位", "头衔", "身份", "履历", "职位",
                         "当过什么", "当过哪些", "做过哪些", "做过什么", "官职"]],
    ...
    },
    {
        ...
        "keywords": ["在哪", "哪里", "何地", "地点", "哪儿", "什么地方", "召开地",
                     "哪座城市", "什么位置", "会址", "哪个省", "举办城市", "地方叫什么"],
        # 「在哪」过于贪心：「重要性体现在哪」问意义、「在哪些事情上出过力」问事迹，均须让位
        "exclude": ["重要性", "意义", "影响", "作用", "历史地位", "体现在", "哪些事", "年份"],
    ...
    },
    {
        ...
        "keywords": ["主要内容", "内容", "讲了什么", "决定了什么", "议程", "通过了什么",
                     "经过", "研究了", "干了些什么", "说了些", "核心议题", "结果是", "哪些问题"],
        "entity_types": ["Meeting", "Event"],
    ...
    },
    {
        ...
        "keywords": ["领导过哪些", "参与过哪些", "领导了哪些", "事迹", "领导过", "参与过", "做了什么", "领导了什么",
                     "这一生", "贡献", "大事", "出过力", "功绩", "参加过什么", "经历了什么", "干过哪些"],
        "entity_types": ["Person"],
    ...
    },
    {
        ...
        "keywords": ["有哪些大事", "重大事件", "哪些事件", "大事", "发生了什么", "有哪些事",
                     "重要节点", "大事记", "历史脉络", "值得一提", "关键事情", "都经历了什么"],
        "entity_types": ["Period"],
